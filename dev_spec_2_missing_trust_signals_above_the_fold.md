...
Site: voicenotes.com · Priority 2 · High · Effort: Medium (2-5 days)

## Problem
The homepage shows no sign of returns policy, guarantee, so a first-time visitor has nothing to offset purchase risk.

## Evidence (from the live site)
> Measured on the live homepage: no match for returns policy, guarantee.

## Current state
notes: absent: returns policy, guarantee
